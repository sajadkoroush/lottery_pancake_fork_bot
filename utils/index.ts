...
import lotteryABI from "../abi/PanbulcSwapLottery.json";

/**
 * Get the ticket price, based on current network, as $Bulc.
...
export const getTicketPrice = async (
  ...
  // Compute the ticket price (denominated in $Bulc), to the required USD eq. value.
